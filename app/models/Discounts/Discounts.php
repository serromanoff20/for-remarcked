...
//            $this->countDiscount++;
    ...
    {
        foreach ($this->typesDiscount as $type) {
            $execDiscount = 'for' . $type;
            if ($this->$execDiscount) {
                $fullNameType = 'discount' . $type;
                $baseCost -= ($baseCost * $this->$fullNameType);
            }
        }
